          ...
          <div>
            ...
            <div className="card">
              <CardBody>
                  ...
                  <Col className="was-validated text-center">
                    <Input type="text" className="form-control-warning" name="id"
                      ...
                      // value={this.state.test}
                           ...
                           title={"OCR: " + values.id_prob + "%"}
                           placeholder={strings.plc_id}
                           required/>
                  </Col>
                ...
                <Row>
                  <Col className="was-validated text-center">
                    <Input type="text" className="form-control-warning" name="dob"
                           ...
                           data-toggle="tooltip" data-placement="right"
                           title={"OCR: " + values.dob_prob + "%"}
                           placeholder={strings.plc_dob}
                           required/>
                  </Col>
                ...
                <Row>
                  <Col className="was-validated text-center">
                    <Input type="text" className="form-control-warning" name="town"
                           onChange={handleChange('town')}
                           defaultValue={values.town}
                           data-toggle="tooltip" data-placement="right"
                           title={"OCR: " + values.town_prob + "%"}
                           placeholder={strings.plc_town}
                           required/>
                  </Col>
                ...
                <Row>
                  <Col className="was-validated text-center">
                    <Input type="text" className="form-control-warning" name="address"
                           ...
                           data-toggle="tooltip" data-placement="right"
                           title={"OCR: " + values.address_prob + "%"}
                           placeholder={strings.plc_addr}
                           required/>
                  </Col>
