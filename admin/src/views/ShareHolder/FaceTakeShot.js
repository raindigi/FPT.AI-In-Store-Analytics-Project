...
import {Row, Col, CardBody, Button, Input, ModalHeader, ModalBody, ModalFooter, Modal} from "reactstrap";
          ...
          <div>
            ...
            <div className="card">
              <CardBody>
                <Row>
                  <Col className="text-center">
                    <span className={styles.titleInformStyle}>{strings.face_command}</span>
                  </Col>
                </Row>
                <br/>
                <Row>
                  <Col className="text-center">
                    <Input className={styles.hiddenInputStyle} type="file" id="file-input2" name="file-input2"
                           accept="image/*"
                ...
                {this.state.valid === 0 ?
                  <div>
                    ...
                    {this.state.is_mobile ?
                      <div>
                        ...
                        <Row>
                          <Col className="text-center">
                            <button onClick={this.onclick} className={styles.button}>{strings.face_take_button}</button>
                          </Col>
                        </Row>
                      </div>
                      :
                  ...
                  <div>
                    {this.state.is_mobile ?
                      ...
                      <Row>
                        <Col className={"text-center " + styles.imageStylePc}>
                          <img src={this.state.image_root} className={styles.imageStylePc} alt="N/A"
                               hidden={this.state.imageState}/>
                        </Col>
                      </Row>
                    }
